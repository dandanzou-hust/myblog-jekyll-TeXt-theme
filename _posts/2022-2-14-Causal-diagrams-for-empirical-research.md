...
其中 $$pa_i$$ 是 $$G$$中 $$X_i$$ 的直接前节点（称为 parents）。公式2中的递归分解表明，设置前节点为 $$pa_i$$ ，每个变量 $$X_i$$ 和它其他的前节点 $$\{X_1,X_2,...,X_i-1\}\pa_i$$是条件独立的。使用Dawid的符号[1979]，我们可以阐述这种独立如下：
